...
- The mcp-guard CLI tool
- The mcp-guard web dashboard and API
- The proxy functionality

## What to Report

- Security vulnerabilities in mcp-guard code
...
- Vulnerabilities in MCP servers that mcp-guard scans (not our code)
...
mcp-guard implements several security measures:
...
Keep mcp-guard updated to get the latest security patches:

```bash
cargo install mcp-guard --force
```
